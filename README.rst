...
२. अनुवाद करणे
अनुवाद करण्यासाठी आपल्याला ``.po`` फाईलींचे संपादन करायचे आहे. ``.po`` फाईल ही एक साधी मजकूर फाईल असल्यामुळे कोणत्याही मजकूर संपादकात (उदा. विंडोजवरील वरील ``notepad.exe`` मध्ये) ती उघडून तिच्यात बदल करता येतो. तसेच ``.po`` फाईलींचे विशेष संपादक देखील उपलब्ध आहे, `poedit <https://poedit.net/>`_ नावाचे. त्यात संपादन करणे जास्त सोपे जाऊ शकते. 
